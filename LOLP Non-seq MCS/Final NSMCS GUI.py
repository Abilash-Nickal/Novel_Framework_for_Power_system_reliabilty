...
LOAD_FILE_A = "../data/SRILANKAN_LOAD_CURVE_MODIFIED.csv"
LOAD_FILE_B = "../data/SriLanka_Load_8760hr_Random.csv"
...
class ReliabilityGUI:
    ...
    def show_results(self, lolp, lole, duration, iterations, selected_load_path):
        ...
        messagebox.showinfo("Success", "Monte Carlo Simulation Finished.")
