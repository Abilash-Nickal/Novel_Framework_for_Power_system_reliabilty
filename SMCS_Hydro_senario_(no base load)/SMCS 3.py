...
# Configuration
NUM_YEARS =1000 # Set to 100,000 years for statistical accuracy and practical runtime
HOURS_PER_YEAR = 8760 # The number of hours in a non-leap year

# monthly hydro capacity cap (MW) for each month (Jan..Dec).
MONTHLY_HYDRO_CAPACITY_MW = [853,866,1011,916,1023,1133,1061,964,939,1057,1184,1118]
...
def run_sequential_mcs(gen, MTTF, MTTR, Annual_Load_Profile, is_hydro, monthly_hydro_capacity_mw=None):
    ...
    while current_time < total_study_hours:
        ...
        # Log progress periodically (every 100 simulated years)
        if current_time % (HOURS_PER_YEAR * 100) <= time_step and current_time > 0:
            print(
