...
import random  # Including random for safety, though np.random is used
...
def load_data(gen_file, load_file):
    try:
        ...
        required_gen_cols = ['Unit Capacity (MW)', 'MTTF (hours)', 'MTTR (hours)']
...
# -----------------------------
def run_smcs(Gen, MTTF, MTTR, Load, years=1000):
    HOURS = 8760
